...
fetch(API_URL)
  ...
  .then(result => {
    ...
    //console.log(data); usei este concolse.log pra testar a conexao com a API no navegador inspecionar console
    ...
    data.map(element => {
      ...
      image.src = photo; //o elemento photo veio na desestruturacao do data
